...
export default async function DashboardPage({ searchParams }: DashboardPageProps) {
  ...
  return (
    <main className="min-h-screen bg-black text-white pb-20 selection:bg-brand-green selection:text-black">
      ...
      {/* Hero Section - Hide in specialized lists like Sports/MyList if needed, but keeping for premium feel */}
      ...
      <div className={`relative z-20 space-y-8 ${!isSports ? "-mt-20" : "pt-24"}`}>
        ...
        {category === "inicio" && (
          <>
            <MovieRow title="Filmes em Destaque" movies={trendingMovies} glowColor="green" />
            <MovieRow title="Séries Populares" movies={trendingSeries} glowColor="blue" />
            ...
            <MovieRow title="Conteúdo Kids" movies={kidsContent} glowColor="yellow" />
          </>
        )}
        ...
        {category === "series" && (
          <>
            ...
            <MovieRow title="Populares na SFL" movies={popularSeries} glowColor="blue" />
            <MovieRow title="Tendências da Semana" movies={trendingSeries} glowColor="green" />
          </>
        )}
        ...
        {category === "movies" && (
          <>
            ...
            <MovieRow title="Populares na SFL" movies={popularMovies} glowColor="green" />
            <MovieRow title="Tendências da Semana" movies={trendingMovies} glowColor="yellow" />
          </>
        )}
        ...
        {category === "trending" && (
          <>
            ...
            <MovieRow title="Filmes em Alta" movies={trendingMovies} glowColor="yellow" />
            <MovieRow title="Séries em Alta" movies={trendingSeries} glowColor="blue" />
          </>
        )}
