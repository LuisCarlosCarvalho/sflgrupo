...
export default async function CatalogoPage() {
  ...
  if (user?.status !== "ACTIVE") redirect("/aguardando-ativacao");
        ...
        <section className="px-6 md:px-12 py-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            {[1, 2, 5, 6].map((i) => (
              <div
                key={i}
                className="aspect-video bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center group opacity-50 grayscale cursor-not-allowed relative overflow-hidden"
              >
