    ...
    >
      ...
      {isMobileMenuOpen && (
        <>
          ...
          <div className="lg:hidden fixed inset-y-0 left-0 w-[300px] z-[60] bg-[#15192A] border-r border-white/5 animate-in slide-in-from-left duration-300 flex flex-col shadow-2xl">
