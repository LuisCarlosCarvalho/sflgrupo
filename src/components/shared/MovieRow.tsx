...
export default function MovieRow({ title, movies, glowColor = "green" }: MovieRowProps) {
  const glowClasses = {
  ...
  return (
    <div className="py-6 space-y-4">
      <h2 className="text-xl md:text-2xl font-black text-white px-6 md:px-12 uppercase tracking-tighter">
        {title}
      </h2>
